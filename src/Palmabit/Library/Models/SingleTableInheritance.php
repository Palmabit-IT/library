<?php namespace Palmabit\Library\Models;
...
abstract class SingleTableInheritance extends Eloquent {
  /**
  ...
  protected function prepareAllAttributes() {
    ...
    while (($parent = get_parent_class($parent)) != 'Palmabit\Library\Models\SingleTableInheritance') {
  ...
  public function isRootCat() {
    return (get_parent_class($this) == 'Palmabit\Library\Models\SingleTableInheritance');
  }
   ...
   * @param string $key
   * @param mixed  $value
   * @throws \Palmabit\Library\Exceptions\InvalidAttributeException
   */
